    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          "@type": "Service",
          name: "3-Day Training Program",
          description: "3 personal training sessions per week with customized programming and nutrition guidance",
        },
        price: "450",
        priceCurrency: "USD",
        priceSpecification: {
      ...
      },
      {
        ...
        itemOffered: {
          "@type": "Service",
          name: "2-Day Training Program",
          description: "2 personal training sessions per week with customized programming and nutrition guidance",
        },
        price: "350",
        priceCurrency: "USD",
        priceSpecification: {
